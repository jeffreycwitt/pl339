...
Today, I'd like to make sure we have a significant amount of time to begin reviewing the work we've done over the past few weeks. So please make sure to look at the [posted exam review sheet](09-exam.html) before class tomorrow. (And of course please annotate the review notes as much as possible). 
...
In short, what I want you to have a general sense of is the **basic debate** taking place in the field of philosophy of language and philosophy of information. This debate is closely related to the question of whether machines are thinking when they process information or whether humans are doing something special when they "think": something special that machines simply cannot do. 
...
<span class="citation" data-reading="3JMTBWNW=>p. 43-44" data-annotation="https://hyp.is/BKhDxtWlEe-Q_J8R8G-KcA/s3.amazonaws.com/lum-faculty-jcwitt-public/pl399/Ilari_2013_Naturalized_Information,_chapter_3.pdf"/>
...
* Is it something machines can do as well? 
* Is a "magic process" that humans alone are capable of? 
* Are human beings the only type of "semantically enabled agents"?
...
> Understanding the fundamentals of this problem is beneficial to appreciate current debates on neuro-physiology (“When does the transduction of information stop and when does the interpretation start within the brain?”), artificial intelligence (“Can we build semantically enabled artificial agents?”), and metaphysics (“Is information the ultimate substance of the universe?”). <span class="citation" data-reading="3JMTBWNW=>p. 44" data-annotation="https://hyp.is/BINgatWlEe-FHQdOxSNZQw/s3.amazonaws.com/lum-faculty-jcwitt-public/pl399/Ilari_2013_Naturalized_Information,_chapter_3.pdf"/>
...
> "Environmental information covers the first part of the naturalization, the natural transfer of information. The tree’s age is communicated by its own physical structure. But an observer must still interpret the structure to extract the information" <span class="citation" data-reading="3JMTBWNW=>p. 46" data-annotation="https://hyp.is/BH1bjtWlEe-N7H-Zn77QAA/s3.amazonaws.com/lum-faculty-jcwitt-public/pl399/Ilari_2013_Naturalized_Information,_chapter_3.pdf"/>
...
> "Equivocation occurs if several different events at the source are conflated into one observed event with the receiver, thereby rendering it impossible to infer exactly which event at the source produced the event with the receiver." <span class="citation" data-reading="3JMTBWNW=>p. 46" data-annotation="https://hyp.is/BH1bjtWlEe-N7H-Zn77QAA/s3.amazonaws.com/lum-faculty-jcwitt-public/pl399/Ilari_2013_Naturalized_Information,_chapter_3.pdf"/>
...
{:#at-any-rate-it}
> "At any rate, it should be clear by now what it means for environmental information to pass through a channel that is equivocation-free: it means that information is not irreversibly lost." <span class="citation" data-reading="3JMTBWNW=>p. 46" data-annotation="https://hyp.is/BCcratWlEe-N5CfVACO6Tg/s3.amazonaws.com/lum-faculty-jcwitt-public/pl399/Ilari_2013_Naturalized_Information,_chapter_3.pdf">
...
> "Equivocation-free transfer of information therefore prepares the way for the extraction of the content from the signal." <span class="citation" data-reading="3JMTBWNW=>p. 47" data-annotation="https://hyp.is/BCcratWlEe-N5CfVACO6Tg/s3.amazonaws.com/lum-faculty-jcwitt-public/pl399/Ilari_2013_Naturalized_Information,_chapter_3.pdf">
...
> "Any propositional content exhibiting the third order of intentionality is a semantic content." <span class="citation" data-reading="3JMTBWNW=>p. 49" data-annotation="https://hyp.is/BCcratWlEe-N5CfVACO6Tg/s3.amazonaws.com/lum-faculty-jcwitt-public/pl399/Ilari_2013_Naturalized_Information,_chapter_3.pdf">
...
{:#the-experience-of-a}
>  "the  experience  of  a  sound  we  hear  is  intentional  with respect  to  the  object  that  produces  the  sound,  not  with  respect  to  the  vibration  of  our  ear  drums, although the latter is implied by our having the experience." <span class="citation" data-reading="3JMTBWNW=>p. 49" data-annotation="https://hyp.is/A8yRWtWlEe-Nws8NITb2OA/s3.amazonaws.com/lum-faculty-jcwitt-public/pl399/Ilari_2013_Naturalized_Information,_chapter_3.pdf">

So for example, when my ear senses the various vibrations of a bird singing, and then I go the next step to form an idea or **intention**, I am hearing "melodic sounds", then I am in a particular intentional state. The vibrations I hear and feel do not make me think of vibrations, but of "a particular type of melodic sound".

Notice that if in the information transfer was "equivocal" it cannot produce this kind of intention. I receive the vibrations, but the equivocation makes impossible for me to tie this back to an object of reference.

With this notion of "intentionality" in place Dretske goes further. 
...
The suggestion is that there is another step to be taken. By itself, my intention of "melodic sound" (*t* is in state *F*) may not yet be sufficient for me form the belief (or extract semantic meaning from my intention) that "a bird is singing" or "this is the song of a bird".

The final step is the development of a distinction between communicated information about matter of fact, "there is melodic noise" (t is f) and **type level** information, the concept of a "bird's song" allowing one to say, "this is a bird's song."

In other words: a semantically enabled agent must be further capable of subsuming this *intention* under pre-understood *type*. (We might call this a pre-understood protocol). To take this final step we need to be capable of saying, "this kind of melodic sound falls under the category/type of *bird's song*". Once done, I can receive the intention of the "melodic noise" and extract it's meaning, "this is a bird's song".

Illari says it this way:

> "Now, with regards to how natural information can give rise to symbolic communication, another important idea is required: the difference between a piece of information about a particular matter of fact, and the corresponding content the information has on a type level." <span class="citation" data-reading="3JMTBWNW=>p. 49-50" data-annotation="https://hyp.is/A42cXNWlEe-BnQvNhJJyig/s3.amazonaws.com/lum-faculty-jcwitt-public/pl399/Ilari_2013_Naturalized_Information,_chapter_3.pdf">
...
These concepts can be agreed to ahead of time, or they can emerge organically through conventional practice. Illari writes:
...
But in either case, these concepts/types function as shared protocol between sender and receiver.

The point is: once these concepts have a emerged, intentional states can correlate one state of affairs with a concept classification. This is, in a sense, Dretske's attempt to explain the extraction of meaning or the extraction of semantics "naturally" rather than assuming the human mind has magical powers to understanding "meaning". 

As the reading state: 

> "Knowledge of concepts is a form of  type-level  knowledge,  and  that  is  what  is  required  for  symbolic  communication." <span class="citation" data-reading="3JMTBWNW=>p. 50" data-annotation="https://hyp.is/A1jlwNWlEe-f2rvYCLoNKw/s3.amazonaws.com/lum-faculty-jcwitt-public/pl399/Ilari_2013_Naturalized_Information,_chapter_3.pdf">
...
* What view is Dretske opposing? 
  * Why does this opposing view think the "naturalization of semantic content" is impossible?
* What does Dretske think will be a sign that someone or something understands semantics/meaning?
* How does the invocation of type-level information become a way for Dretske to describe when something has understood a "meaning" (This is probably the most difficult question for us, but, given our goals, the precise details of this move are the least important.)
  * Does the classification of an intentional state under a concept/type sound to you like what you do when you think you understand the meaning of something?
    * When I say the word "squirrel" to you, what is a sign to you that you and I understand the same meaning?
    * If I said to you "Bob squirrel the oven", why might you have trouble understanding my meaning? 
      * What does this word "squirrel" make you think of (what intention do you have)? 
      * What does your intention and my use of the word in the sentence make it difficult for you to understanding any meaning (i.e. subsume your intention under a previously known concept/category/type (i.e. an understood protocol?)).
    * If I said to someone, "go get the squirrel", what would be a sign to you that they did not understand my meaning?
  * Do you think an information processing machine could be capable of this kind of type classification?
